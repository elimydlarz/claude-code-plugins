...
- At session start: the SessionStart hook hands the agent its session id and surfaces other sessions' recorded handovers (last step + remaining steps) so work continues across sessions.
