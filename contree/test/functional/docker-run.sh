...
ALL_TESTS=(incidental-pass setup-generates-requirements tdd-writes-requirement-first stop-hook-fires setup-docker-testing discover-change discover-sync discover-setup discover-tdd pressure-injection)
