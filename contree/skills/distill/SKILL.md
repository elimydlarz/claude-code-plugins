...
1. **Never modify test trees.** Every line under `## Requirements` stays byte-for-byte identical. If a tree looks stale, ask the user — do not edit it unilaterally. Same rule the stop hook enforces.
