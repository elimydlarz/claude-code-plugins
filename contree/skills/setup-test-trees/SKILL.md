...
Use `change` to reconcile the evidence with the operator through `change` into layered EARS trees with honest coverage. Follow its consumer-driven layering, causal nesting, one-tree-one-test-file boundary, and coverage syntax.
