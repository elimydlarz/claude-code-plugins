...
- **`/contree:setup`** — Configures your test framework with tree reporters, normal and functional test commands, linting, and creates `TEST_TREES.md` when needed. Run once per project.
...
1. Run `/contree:setup` — sets up the test framework, normal and functional test commands, linting, and creates `TEST_TREES.md` when needed
