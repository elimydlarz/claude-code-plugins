...
- **`/contree:tdd`** — Auto-triggers when implementing behaviour. Runs one observable behaviour through RED, GREEN, and REFACTOR; observed branching is encapsulated by a mocked unit whose consumer-established behaviour is then TDDed recursively.
