#!/usr/bin/env bash
# SessionStart hook: print rules cheatsheet plus one random pressure phrase to stderr.
# Claude Code injects SessionStart stdout (and stderr on exit 2) into the model's context.
